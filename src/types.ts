...
export type RuntimeEventType =
  ...
  | "task_graph.budget_adjusted"
  | "task_graph.failure_clustered"
  | "task_graph.replan_quality"
  | "task_graph.replan_planned"
  | "task_graph.replan_skipped"
  | "task_graph.replanned"
  | "task_graph.quality"
  | "task_graph.node_added"
  | "task_graph.node_updated"
  | "task_graph.node_deleted"
  | "tool.hints.resolved"
